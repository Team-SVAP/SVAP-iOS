...
//        provider.request(.createPetition(title: titleTextField.text!, content: contentTextView.text!, types: petitionTypeLabel.text!, location: placeTextField.text!, image: )) { res in
//            switch res {
